...
var root = document.getElementById('root'); /* eslint-disable */
...
var Main = function (_React$Component) {
  ...
  _createClass(Main, [{
    ...
    value: function onAddProduct(ev) {
      ...
      _axios2.default.post('/api/products', { name: inputValue }).then(function (res) {
        return res.data;
      }).then(function (product) {
        return _this3.setState({ products: [].concat(_toConsumableArray(products), [product]) });
      });
    ...
    value: function render() {
      ...
      var onAddProduct = this.onAddProduct,
      ...
      return _react2.default.createElement(
        ...
        _react2.default.createElement(_Products2.default, { products: products, onAddProduct: onAddProduct, onChange: onChange })
      );
    }
  }]);
  ...
  _createClass(Products, [{
    ...
    value: function render() {
      var _props = this.props,
          ...
          onAddProduct = _props.onAddProduct,
